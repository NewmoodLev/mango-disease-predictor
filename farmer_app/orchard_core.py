...
def synthesize_features(positions: np.ndarray,
    ...
    """
    สร้าง (T=7, N, 4) feature window สำหรับป้อนเข้า STGNN
    จำลอง 7 วันย้อนหลังด้วย SEIR เพื่อให้ตรง distribution ที่ train มา
...
# SEIR parameters — ใช้ใน synthesize_features เพื่อสร้าง feature window (input ให้ STGNN)
